...
const IntegrationCard = ({ icon: Icon, name }: { icon: any; name: string }) => (
  <div className="group relative z-20 flex h-20 w-20 cursor-pointer items-center justify-center rounded-2xl border border-gray-100 bg-white shadow-[0_4px_20px_-10px_rgba(0,0,0,0.1)] transition-all duration-300 hover:-translate-y-2 hover:border-blue-100 hover:shadow-xl">
    <Icon />
    {/* Tooltip */}
    <div className="absolute -bottom-10 left-1/2 w-max -translate-x-1/2 rounded-md bg-gray-900 px-3 py-1.5 text-xs font-semibold text-white opacity-0 transition-all duration-200 group-hover:bottom-[-45px] group-hover:opacity-100">
        {name}
    ...
    <section className="bg-white py-24 sm:py-32 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        <motion.span 
          ...
          viewport={{ once: true }}
          className="mb-4 inline-flex items-center rounded-full bg-gray-100 px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-gray-500 shadow-sm border border-gray-200"
        >
          Integrations
        </motion.span>
        ...
        <motion.h2 
          ...
          className="mb-12 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl"
        >
        ...
        <div className="relative mx-auto mt-16 max-w-6xl">
           ...
           {/* Central Hub */}
           <div className="relative z-30 mx-auto mb-10 flex h-20 w-20 items-center justify-center rounded-[2rem] bg-white shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] ring-1 ring-gray-100">
               <div className="grid grid-cols-2 gap-2">
                    <div className="h-3.5 w-3.5 rounded-full bg-blue-600"></div>
                    <div className="h-3.5 w-3.5 rounded-full bg-blue-400"></div>
               ...
               <div className="absolute top-full left-1/2 h-8 w-px bg-gradient-to-b from-gray-200 to-gray-300"></div>
           </div>

           {/* Branching Lines Structure */}
           <div className="relative mx-auto mb-8 max-w-[880px]">
               {/* Main Horizontal Line */}
               <div className="absolute -top-2 left-0 h-px w-full bg-gradient-to-r from-transparent via-gray-200 to-transparent"></div>
               ...
               <div className="flex justify-between px-4 sm:px-10">
                   {[...Array(7)].map((_, i) => (
                       <div key={i} className="relative flex w-20 justify-center">
                           <div className="absolute -top-2 h-6 w-px bg-gray-200"></div>
                           {/* Small dot at connection point */}
                           <div className="absolute -top-2 h-1.5 w-1.5 rounded-full bg-gray-300"></div>
                       </div>
                   ))}
               </div>
           </div>
